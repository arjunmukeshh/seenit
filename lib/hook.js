...
//
// It warns; it does not block. Three reasons, all of them measured:
//
//   - Recall is 0.84 on a verbatim copy and 0.73 once statements move. A thing
...
//   - The listing runs at 0.62 precision. Blocking on that would reject real
//     work often enough to get the hook switched off within a day.
//   - find_existing, which is what this actually calls, returned zero false
//     positives in 62 repositories. Warning on that is cheap and rarely wrong;
//     blocking on it still fails the first two points.
//

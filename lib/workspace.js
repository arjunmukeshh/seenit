...
// Hash every working-tree file in ONE git process. Same reasoning as
// readBlobsBatch: per-file spawning dominates runtime otherwise.
export async function hashWorkingFiles(repoRoot, paths) {
